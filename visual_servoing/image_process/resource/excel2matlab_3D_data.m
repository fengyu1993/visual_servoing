...
%% 保存数据
save("DCT_VS_experience_data_3D.mat", "DCT_VS_camera_velocity", "DCT_VS_camera_pose", "DCT_VS_error_feature", "DCT_VS_error_pixel", "DCT_VS_order");
save("TM_VS_experience_data_3D.mat", "TM_VS_camera_velocity", "TM_VS_camera_pose", "TM_VS_error_feature", "TM_VS_error_pixel", "TM_VS_order");
save("KM_VS_experience_data_3D.mat", "KM_VS_camera_velocity", "KM_VS_camera_pose", "KM_VS_error_feature", "KM_VS_error_pixel", "KM_VS_order", "KM_VS_pxy");
save("HM_VS_experience_data_3D.mat", "HM_VS_camera_velocity", "HM_VS_camera_pose", "HM_VS_error_feature", "HM_VS_error_pixel", "HM_VS_order", "HM_VS_abxy");
