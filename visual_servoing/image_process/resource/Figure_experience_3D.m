...
[error_pose_DCT, T_DCT] = get_pose_error_T(DCT_VS_camera_pose, DCT_VS_camera_pose_desired);
...
[error_pose_HM, T_HM] = get_pose_error_T(HM_VS_camera_pose, HM_VS_camera_pose_desired);
velocity_HM = HM_VS_camera_velocity;
order_list_HM = HM_VS_order;
parameter_ab_xy_HM = HM_VS_abxy;
load('KM_VS_experience_data_3D.mat');
error_feature_KM = KM_VS_error_feature;
error_pixel_KM = KM_VS_error_pixel*resolution_x*resolution_y;
[error_pose_KM, T_KM] = get_pose_error_T(KM_VS_camera_pose, KM_VS_camera_pose_desired);
...
[error_pose_TM, T_TM] = get_pose_error_T(TM_VS_camera_pose, TM_VS_camera_pose_desired);
