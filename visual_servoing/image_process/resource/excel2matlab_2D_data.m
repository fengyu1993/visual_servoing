...
%% 读取DCT_VS_data
[~, ~, DCT_VS_data] = xlsread(location_name+'DCT_VS_data_2D.xlsx');
DCT_VS_camera_velocity = get_camera_velocity_data(DCT_VS_data, camera_velocity_name, camera_pose_name);
DCT_VS_camera_pose = get_camera_pose_data(DCT_VS_data, camera_pose_name, error_feature_ave_name);
...
%% 读取TM_VS_data
[~, ~, TM_VS_data] = xlsread(location_name+'TM_VS_data_2D.xlsx');
TM_VS_camera_velocity = get_camera_velocity_data(TM_VS_data, camera_velocity_name, camera_pose_name);
TM_VS_camera_pose = get_camera_pose_data(TM_VS_data, camera_pose_name, error_feature_ave_name);
...
%% 读取KM_VS_data
[~, ~, KM_VS_data] = xlsread(location_name+'KM_VS_data_2D.xlsx');
KM_VS_camera_velocity = get_camera_velocity_data(KM_VS_data, camera_velocity_name, camera_pose_name);
KM_VS_camera_pose = get_camera_pose_data(KM_VS_data, camera_pose_name, error_feature_ave_name);
...
%% 读取HM_VS_data
[~, ~, HM_VS_data] = xlsread(location_name+'HM_VS_data_2D.xlsx');
HM_VS_camera_velocity = get_camera_velocity_data(HM_VS_data, camera_velocity_name, camera_pose_name);
HM_VS_camera_pose = get_camera_pose_data(HM_VS_data, camera_pose_name, error_feature_ave_name);
...
%% 保存数据
save("DCT_VS_experience_data_2D.mat", "DCT_VS_camera_velocity", "DCT_VS_camera_pose", "DCT_VS_error_feature", "DCT_VS_error_pixel", "DCT_VS_order");
save("TM_VS_experience_data_2D.mat", "TM_VS_camera_velocity", "TM_VS_camera_pose", "TM_VS_error_feature", "TM_VS_error_pixel", "TM_VS_order");
save("KM_VS_experience_data_2D.mat", "KM_VS_camera_velocity", "KM_VS_camera_pose", "KM_VS_error_feature", "KM_VS_error_pixel", "KM_VS_order", "KM_VS_pxy");
save("HM_VS_experience_data_2D.mat", "HM_VS_camera_velocity", "HM_VS_camera_pose", "HM_VS_error_feature", "HM_VS_error_pixel", "HM_VS_order", "HM_VS_abxy");
